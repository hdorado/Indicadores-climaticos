...
#VINCULACULACIÓN DATOS CLIMATICOS 

setwd("C:/Users/hadorado/Desktop/TALLER_MANAGUA/IDICADORES_CLIMATICOS")

source("funcionesClimaticas.R")

lotes    <- read.csv("Lotes.csv")
...
cosechBase      <-  lotes
climBase        <-  read.csv("station_JOINT.csv")
...
write.csv(data.frame(lotes,a),"eventos_clima_arroz.csv")
